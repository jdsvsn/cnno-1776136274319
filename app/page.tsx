...
const basePath = '/cnno-1776136274319';
...
export default function Home() {
  ...
  const products = [{ n: 'OG Rolls', d: 'Craving some classics?', i: 'https://lh3.googleusercontent.com/d/1woasEyomvwYhxzJL10Mim-0UbLQxTbS_', icon: 'domain' }, { n: 'Pistachio Rolls', d: 'For the nut lovers!', i: 'https://lh3.googleusercontent.com/d/11D3BokoKOS9hZq2nzknvCnzl89kUTsYk', icon: 'architecture' }, { n: 'Chocolate Rolls', d: 'Can\'t go wrong with chocolate!', i: 'https://lh3.googleusercontent.com/d/1AwOE1eD9q_VEAEcjhEM0EbS_zxUuLFeL', icon: 'chair' }, { n: 'Baby Rolls', d: 'Small bites for snack time!', i: 'https://lh3.googleusercontent.com/d/1bwlje-2NC8HKfaOmDBBxQJy0zcmhzcCa', icon: 'eco' }, { n: 'Party Box', d: 'The best deal for parties!', i: 'https://lh3.googleusercontent.com/d/1cgNqm4QqGt0T2Rfe6KqROlcUp8reHq1I', icon: 'precision_manufacturing' }];
    ...
    <div className="min-h-screen bg-surface text-on-surface font-body selection:bg-accent/30 selection:text-primary">
      ...
      <nav className="fixed top-0 w-full z-50 bg-white/80 backdrop-blur-xl shadow-sm">
        <div className="flex justify-between items-center w-full px-8 py-4 max-w-7xl mx-auto">
          <div className="flex items-center gap-3">
            ...
            <span className="text-2xl font-black tracking-tighter text-primary font-headline">CNNO</span>
          </div>
      ...
      <section id="home" className="relative h-screen flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0 z-0">
          <img src="https://lh3.googleusercontent.com/d/1GXOUzZGJDeAauHp-Wwgn-HeNR1znr560" alt="Hero" className="w-full h-full object-cover" />
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-8 w-full">
          <div className="max-w-3xl">
            ...
            <h1 className="font-headline text-5xl md:text-7xl font-extrabold text-white leading-[1.1] mb-8 tracking-tighter">
              Sweet Rolls for <span className="text-accent">Warm Souls.</span>
            </h1>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
            <div className="lg:col-span-5 space-y-8">
              ...
              <div className="grid grid-cols-2 gap-8 pt-8">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-sm text-on-surface-variant">To craft exceptional cinnamon rolls and baked goods that exceed customer expectations, while fostering a warm and inviting community that shares our passion for quality, comfort, and indulgence.</p>
                </div>
                <div className="space-y-2">
            ...
            <div className="lg:col-span-7 grid grid-cols-12 grid-rows-6 gap-4 h-[600px]">
              <div className="col-span-8 row-span-4 overflow-hidden rounded-xl">
                <img src="https://lh3.googleusercontent.com/d/1l5hLLTA9B3LqPKN3eTJgm4SRZLDfGSgp" alt="About 1" className="w-full h-full object-cover" />
              </div>
              <div className="col-span-4 row-span-3 overflow-hidden rounded-xl bg-surface-container">
                <img src="https://lh3.googleusercontent.com/d/1zGSGvhUzgiFU_AvQMXF5VsUZn2CIzVZ4" alt="About 2" className="w-full h-full object-cover" />
              </div>
              <div className="col-span-5 row-span-2 overflow-hidden rounded-xl mt-4">
                <img src="https://lh3.googleusercontent.com/d/1kLXDAjkGM7ogEo8jfXYLKc7nNh3rjCBF" alt="About 3" className="w-full h-full object-cover" />
              </div>
            </div>
          </div>
        </div>
              ...
              <div className="space-y-12">
                ...
                <div className="flex gap-6">
                  ...
                  <div>
                    ...
                    <p className="text-white/60 text-sm">014-2899656</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <footer className="bg-primary w-full py-12 px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-7xl mx-auto items-center text-center md:text-left">
          <div>
            ...
            <p className="text-white/60 text-sm leading-relaxed">Sweet Rolls for Warm Souls</p>
          </div>
          ...
          <div className="md:text-right">
            <p className="text-white/60 text-sm leading-relaxed">
              &copy; {new Date().getFullYear()} CNNO. All rights reserved.
            </p>
          </div>
        </div>
      </footer>
